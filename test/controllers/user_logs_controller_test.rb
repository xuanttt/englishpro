...
class UserLogsControllerTest < ActionController::TestCase
  ...
  test "should create user_log" do
    assert_difference('UserLog.count') do
      post :create, user_log: { act: @user_log.act, act_id: @user_log.act_id, log_data: @user_log.log_data, status: @user_log.status, user_id: @user_log.user_id }
    end
  ...
  test "should update user_log" do
    patch :update, id: @user_log, user_log: { act: @user_log.act, act_id: @user_log.act_id, log_data: @user_log.log_data, status: @user_log.status, user_id: @user_log.user_id }
    assert_redirected_to user_log_path(assigns(:user_log))
  end
